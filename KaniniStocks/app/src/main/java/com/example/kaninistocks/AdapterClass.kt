...
class AdapterClass(var songs:MutableList<StockitemData>,var context: Context):RecyclerView.Adapter<AdapterClass.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.text1.text=songs[position].name
    ...
    inner class ViewHolder(itemView:View):RecyclerView.ViewHolder(itemView){
        ...
        init{
            itemView.setOnClickListener{
                id=adapterPosition
                val intent=Intent(context,StocksPage::class.java)
